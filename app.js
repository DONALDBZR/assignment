...
class Server {
    ...
    handleRequest() {
        ...
        this.application.get(
            ...
            (request, response) =>
                response.sendFile(__dirname + "/views/Pages/Homepage.html")
        );
        ...
        this.application.get(
            ...
            this.cors(this.corsOptions),
            (request, response) =>
                response.sendFile(__dirname + "/views/Pages/Sponsors.html")
        );
        ...
        this.application.get(
            ...
            this.cors(this.corsOptions),
            (request, response) =>
                response.sendFile(__dirname + "/views/Pages/Gallery.html")
        );
        ...
        this.application.get(
            ...
            this.cors(this.corsOptions),
            (request, response) =>
                response.sendFile(__dirname + "/views/Pages/CallForPapers.html")
        );
        ...
        this.application.get(
            ...
            this.cors(this.corsOptions),
            (request, response) =>
                response.sendFile(__dirname + "/views/Pages/Keynotes.html")
        );
        ...
        this.application.get(
            ...
            this.cors(this.corsOptions),
            (request, response) =>
                response.sendFile(__dirname + "/views/Pages/Members.html")
        );
